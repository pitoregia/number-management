...
<body>
    ...
    <div class="card col-10 mt-4 mx-auto shadow">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['deskripsi'] ?></td>
                        <td>
                            <button data-number="<?= $row['nomor_telp'] ?>" data-description="<?= $row['deskripsi'] ?>" class="notifyButton btn btn-primary"><i class="fa-regular fa-paper-plane"></i> Send</button>
                        </td>
                    </tr>
    ...
    <script src="assets/js/send_notif.js"></script>
